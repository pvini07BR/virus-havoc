...
func _on_GunDexButton_pressed():
	GameManager.get_node("Fade").path = "res://scenes_and_scripts/runnables/menus/Gundex.tscn"
	GameManager.get_node("Fade/layer/anim").play("fadeOut")

func _on_ModsButton_pressed():
	GameManager.get_node("Fade").path = "res://scenes_and_scripts/runnables/menus/mods.tscn"
	GameManager.get_node("Fade/layer/anim").play("fadeOut")

func _on_settingsButton_pressed():
	GameManager.get_node("Fade").path = "res://scenes_and_scripts/runnables/menus/TouchscreenUISettings.tscn"
	GameManager.get_node("Fade/layer/anim").play("fadeOut")
