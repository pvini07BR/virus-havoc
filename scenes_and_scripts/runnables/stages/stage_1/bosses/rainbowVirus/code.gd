...
onready var brokenSprite = preload("res://scenes_and_scripts/runnables/stages/stage_1/bosses/rainbowVirus/bossVirus_RainbowBroken.png")
onready var damageIndicator = preload("res://scenes_and_scripts/entities/damageIndicator.tscn")
onready var projectile = preload("res://scenes_and_scripts/bullets/virus/rainbowVirusBullet/rainbowVirusBullet.tscn")
onready var laserBeam = preload("res://scenes_and_scripts/bullets/virus/rainbowVirusDeadlyLaser/rainbowVirusDeadlyLaser.tscn")
onready var damageSound = preload("res://scenes_and_scripts/runnables/stages/stage_1/sounds/rainbowVirusDamage.wav")
var health = 100
