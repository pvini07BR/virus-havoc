...
onready var pauseUI = preload("res://scenes/PauseUI.tscn")
onready var finishedUI = preload("res://scenes/LevelFinishedUI.tscn")
onready var gunReplacementUI = preload("res://scenes/GunReplacingUI.tscn")
...
func _ready():
	if GameManager.platform == GameManager.PLATFORMS.MOBILE:
		TouchUI = preload("res://scenes/StageTouchscreenUI.tscn")
